...
#### TC-LG-EDGE-004: Importance 边界值测试

| 项目 | 内容 |
|------|------|
| 前置条件 | 知识点 Importance 为边界值 |
| 输入 | KnowledgePoint.Importance = 0.0 / 1.0 / 0.5 |
| 预期输出 | 正常生成学习内容 |
| 验证点 | Importance 边界值处理正确性 |
...
│   └── empty_doc_id_kp.json          # 无文档ID知识点
├── doc_test_data/                    # 文档测试数据
│   ├── basic_docs.json               # 基础文档集
│   └── multi_doc_data.json          # 多文档数据集
...
| 优先级 | 测试类型 | 说明 |
|--------|----------|------|
| P0 | 核心路径测试 | TC-LG-001, TC-LG-SLIDE-001 |
